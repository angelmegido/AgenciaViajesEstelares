window.confirmacion = function confirmacion() {
    ...
    if (pregunta) {
        ...
        window.location = "https://es.wikipedia.org/wiki/Tierra";
...
window.confirmacionMarte = function confirmacionMarte() {
    ...
    if (pregunta) {
        ...
        window.location = "https://es.wikipedia.org/wiki/Marte_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionMercurio = function confirmacionMercurio() {
    ...
    if (pregunta) {
        alert("Te envío a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/Mercurio_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionVenus = function confirmacionVenus() {
    ...
    if (pregunta) {
        alert("Te envío allí a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/Venus_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionJupiter = function confirmacionJupiter() {
    ...
    if (pregunta) {
        alert("Te envío allí a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/J%C3%BApiter_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionSaturno = function confirmacionSaturno() {
    ...
    if (pregunta) {
        alert("Te envío allí a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/Saturno_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionUrano = function confirmacionUrano() {
    ...
    if (pregunta) {
        alert("Te envío allí a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/Urano_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionNeptuno = function confirmacionNeptuno() {
    ...
    if (pregunta) {
        alert("Te envío allí a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/Neptuno_(planeta)";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};
window.confirmacionSol = function confirmacionSol() {
    ...
    if (pregunta) {
        alert("Te envío allí a la velocidad de la luz");
        window.location = "https://es.wikipedia.org/wiki/Sol";
    } else alert("Quizás en otro momento...\n Gracias de todas formas");
};

//# sourceMappingURL=Sol.69ddb042.js.map
